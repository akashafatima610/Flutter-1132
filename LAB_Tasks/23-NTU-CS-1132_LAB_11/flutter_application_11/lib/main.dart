...
void main() {
  runApp(Application11());
}

class Application11 extends StatelessWidget {
  const Application11({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Center(child: Text("LAB - 11"),),
          titleTextStyle: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
          backgroundColor: Colors.green,
        ),
        body: Center(
          child: Text(
            "Firebase Console and CLI Configurations",
...
//   </head>
//   <body>
//     <h1>Hello! This is Akasha's Firebase CLI Deployment!</h1>
//   </body>
// </html>
